...
def search():
    ...
    for j in range(1, len(t)):
        ...
        time = j * 0.01
        print('time:{}, searched area:{},   coverage percentage:{}'.format(time, map.searched_area, map.searched_percen))
        # print(map.searched_area)
        # print(cov_percen)
        #yield x_coord, y_coord, cov_percen, time
        yield color_map, time
...
ani = animation.FuncAnimation(fig2, animate, search, save_count=5000, interval=dt*1000, blit=False, init_func=init, repeat=False)
