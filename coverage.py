...
for j in range(1, len(t)):
    ...
    time = j * 0.01
    cov_percen_list.append(cov_percen)
    time_list.append(time)
    print('time:{:.2}, searched area:{}, total patches:{}, coverage percentage:{}'\
          .format(time, map.searched_area, map.total_area, cov_percen))
...
#开始写入文件
with open('coverage_data/UAV_class5.json','w') as f:
    json.dump(cov_percen_list, f)
    print('coverage percentage loading completed......')
